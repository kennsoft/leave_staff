...
<?php
	...
	<?php
        ...
        mysqli_query($conn,"INSERT INTO tblemployees(FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,Av_leave,role,Phonenumber,Status, location)
		                                      VALUES('$fname','$lname','$email','$password','$gender','$dob','$department','$address','$leave_days','$user_role','$phonenumber','$status', 'NO-IMAGE-AVAILABLE.jpg')         
		") or die(mysqli_error()); ?>
							...
							<section>
								<div class="row">
									...
									<!-- <div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="Designation" type="text" class="form-control" required="true" autocomplete="off">
										</div>
									</div> -->
								</div>
								<!--2nd low--->
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											<label>Emp.NO :</label>
											<input name="empno" type="text" class="form-control" required="true" autocomplete="off">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
